...
COLLECTOR_PORT="${PANDORAS_BOX_LIVE_MIXED_COLLECTOR_PORT:-45472}"
...
WINDOWS_LOCAL_COLLECTOR_PORT="${PANDORAS_BOX_LIVE_MIXED_WINDOWS_LOCAL_COLLECTOR_PORT:-45372}"
...
LOCAL_COLLECTOR_RULE_NAME="${PANDORAS_BOX_WINDOWS_LOCAL_COLLECTOR_NAT_RULE:-mixed-collector-local}"
...
ensure_windows_nat_forward "$LOCAL_COLLECTOR_RULE_NAME" "127.0.0.1" "$WINDOWS_LOCAL_COLLECTOR_PORT" "$COLLECTOR_PORT"
...
start_proxy "0.0.0.0" "$COLLECTOR_PORT" "127.0.0.1" "$WINDOWS_LOCAL_COLLECTOR_PORT"
...
export PANDORAS_BOX_LIVE_MIXED_COLLECTOR_PORT="$COLLECTOR_PORT"
...
docker run --rm \
  ...
  -e PANDORAS_BOX_LIVE_MIXED_COLLECTOR_PORT \
